...
to setup
  ...
  set-patch-size 60
  ask patches [if (remainder pycor 2 = 0) and (remainder pxcor 2 = 0)
    [set pcolor white]]
  ask patches [if (remainder pycor 2 != 0) and (remainder pxcor 2 != 0)
    [set pcolor white]]
  ask patches [if (remainder pycor 2 = 0) and (remainder pxcor 2 != 0)
...
to play
  ...
  [ask patch mouse-xcor mouse-ycor
    [if (count pawns-here) > 0
      [if (pycor = 1)
        [ask patch mouse-xcor (mouse-ycor + 2)
          [set pcolor violet]]]
      ask patch mouse-xcor (mouse-ycor + 1)
        [set pcolor yellow]]]
  ask patches [if pcolor = yellow or pcolor = violet and (remainder pxcor 2 = 0) and (remainder pycor 2 = 0)
    [set pcolor white]]
