...
; Wilensky, U. (1997).  NetLogo Painted Desert Challenge model.
...
To refer to this model in academic publications, please use:  Wilensky, U. (1997).  NetLogo Painted Desert Challenge model.  http://ccl.northwestern.edu/netlogo/models/PaintedDesertChallenge.  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.

In other publications, please use:  Copyright 1997 Uri Wilensky.  All rights reserved.  See http://ccl.northwestern.edu/netlogo/models/PaintedDesertChallenge for terms of use.
@#$#@#$#@
default
true
0
